...
export default function Producto({guitarra, agregarCarrito}) {
    ...
    const {nombre, descripcion, imagen, price} = guitarra[0].attributes
...
export async function getStaticPaths(){
    ...
    return {
        paths,
        fallback: false //Esto genera una pagina 404 en caso de que la guitarra que no exista 
    }
}
